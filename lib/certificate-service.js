...
class GreenlockService {
    ...
    async _uploadCertificate(certificateJob) {
        try {
            ...
            logging.error(`CertificateJob: Failed to upload certificate to Fastly`);
    ...
    async _queueFailedJobs() {
        ...
        for (const job of jobs) {
            ...
            if (certInfo) {
                // TODO: Check fastly for deployment first
                // TODO: Confirm failure state wasn't from uploading renewal(?)
