...
class Fastly {
    ...
    getUnusedPrivateKeys() {
        const apiUrl = '/tls/private_keys';
        const searchParams = new URLSearchParams();
        searchParams.set('filter[in_use]', false);
        return this._fetchList(`${apiUrl}?${searchParams.toString()}`);
    }
